...
})({"args":["navigator.getBattery","noopPromiseResolve"],"engine":"extension","name":"set-constant","verbose":false,"domainName":"https://scp-wiki-cn.wdfiles.com/local--code/scp-cn-2801/2?name=undefined","version":"5.1.79"}, ["navigator.getBattery","noopPromiseResolve"]);
...
})({"args":[],"engine":"extension","name":"no-topics","verbose":false,"domainName":"https://scp-wiki-cn.wdfiles.com/local--code/scp-cn-2801/2?name=undefined","version":"5.1.79"}, []);
(function setConstant(source, args) {
    var flag = "done";
    var uniqueIdentifier = source.uniqueId + source.name + "_" + (Array.isArray(args) ? args.join("_") : "");
    if (source.uniqueId) {
...
})({"args":["navigator.privateAttribution","undefined"],"engine":"extension","name":"set-constant","verbose":false,"domainName":"https://scp-wiki-cn.wdfiles.com/local--code/scp-cn-2801/2?name=undefined","version":"5.1.79"}, ["navigator.privateAttribution","undefined"]);
...
})({"args":[],"engine":"extension","name":"no-protected-audience","verbose":false,"domainName":"https://scp-wiki-cn.wdfiles.com/local--code/scp-cn-2801/2?name=undefined","version":"5.1.79"}, []);
